...
impl Frame {
    ...
    pub fn paint(&self, content_rect: Rect) -> Shape {
        ...
        if shadow == Default::default() {
            ...
            // MEMBRANE: hacky way to add a second dark stroke for to all frames with stroke and shadow

            let outline_opacity = stroke.color.a();
            let outline_shape = Shape::Rect(epaint::RectShape::new(
                ...
                Stroke::new(
                    1.0,
                    Color32::from_black_alpha(200).gamma_multiply_u8(outline_opacity),
                ),
